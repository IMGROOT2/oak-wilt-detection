...
LOCAL_API = False
try:
    from scripts.api_inference_server import get_historical_scenario as _get_historical_scenario
    from scripts.api_inference_server import run_network_simulation as _run_network_simulation
    from scripts.api_inference_server import SimulationRequest
    import asyncio
    LOCAL_API = True
except Exception:
    LOCAL_API = False
